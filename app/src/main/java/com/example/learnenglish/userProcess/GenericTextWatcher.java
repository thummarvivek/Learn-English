    ...
    public void afterTextChanged(Editable editable) {
        ...
        switch (view.getId()) {
            ...
            case R.id.editTextTextPassword:
                ...
                break;
            case R.id.editTextTextPassword1:
                ...
                break;
            case R.id.editTextTextPassword2:
                if (text.length() == 1)
                    editText[3].requestFocus();
                else if (text.length() == 0)
                    editText[1].requestFocus();
                break;
            case R.id.editTextTextPassword3:
                if (text.length() == 1)
                    editText[4].requestFocus();
                else if (text.length() == 0)
                    editText[2].requestFocus();
                break;
            case R.id.editTextTextPassword4:
                if (text.length() == 1)
                    editText[5].requestFocus();
                else if (text.length() == 0)
                    editText[3].requestFocus();
                break;
            case R.id.editTextTextPassword5:
                if (text.length() == 0)
                    editText[4].requestFocus();
                break;
        }
