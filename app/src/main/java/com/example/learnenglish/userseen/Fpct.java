...
import com.example.learnenglish.Adapters.FpctAdapter;
...
public class Fpct extends AppCompatActivity {
    SwipeRefreshLayout fpctswip012;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fpctswip012=findViewById(R.id.fpct012);
        recyclerView=findViewById(R.id.fpctrv012);
        progressDialog =new ProgressDialog(this);
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.setMessage("Your screen are loading");
        progressDialog.show();

        fpctswip012.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override public void run() {
                        ...
                        fpctswip012.setRefreshing(false);
                    }
                }, 4000); // Delay in millis
            }
        });

        fpctswip012.setColorSchemeColors(
    ...
    public void Refresh(){
        ...
        call.enqueue(new Callback<Resultaence>() {
            ...
            public void onResponse(Call<Resultaence> call, Response<Resultaence> response) {
                ...
                Log.e("check", "onResponse: "+arrayList.get(0).getFpct());
                FpctAdapter fpctAdapter=new FpctAdapter(Fpct.this, arrayList);
                recyclerView.setAdapter(fpctAdapter);
            }

            @Override
            public void onFailure(Call<Resultaence> call, Throwable t) {
                Toast.makeText(Fpct.this, ""+t, Toast.LENGTH_SHORT).show();
                progressDialog.show();
