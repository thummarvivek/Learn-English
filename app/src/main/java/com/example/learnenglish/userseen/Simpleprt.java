...
public class Simpleprt extends AppCompatActivity {

    SwipeRefreshLayout sptswip01;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simpleprt);
        arrayList =new ArrayList<>();
        sptswip01=findViewById(R.id.spt01);
        recyclerView=findViewById(R.id.sptrv01);
        ...
        sptswip01.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override public void run() {
                        ...
                        sptswip01.setRefreshing(false);
                    }
                }, 4000); // Delay in millis
            }
        });

        sptswip01.setColorSchemeColors(
    ...
    public void Refresh(){
        ...
        call.enqueue(new Callback<Resultaence>() {
            ...
            public void onResponse(Call<Resultaence> call, Response<Resultaence> response) {
                ...
                Log.e("check", "onResponse: "+arrayList.get(0).getPst());
                SptAdapter sptAdapter=new SptAdapter(Simpleprt.this, arrayList);
                recyclerView.setAdapter(sptAdapter);
            }

            @Override
            public void onFailure(Call<Resultaence> call, Throwable t) {
                Toast.makeText(Simpleprt.this, ""+t, Toast.LENGTH_SHORT).show();
                progressDialog.show();
